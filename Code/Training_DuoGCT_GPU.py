...
GCTNet-main/train.py (memes reseaux, meme melange signal + bruit a SNR variable).
    ...
    python Training_DuoGCT_GPU.py                      # les deux modeles, bruit Hybrid
    python Training_DuoGCT_GPU.py --model GCTNet --noise EOG
    python Training_DuoGCT_GPU.py --model DuoCL --epochs 50 --noise EMG
...
def main():
    ...
    if not torch.cuda.is_available():
        raise SystemExit(
            ...
            "  - Sinon, utilisez Training_DuoGCT_CPU.py pour un entrainement sur processeur.")
